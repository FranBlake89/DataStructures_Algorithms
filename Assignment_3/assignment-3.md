...
* You must take a screenshot of the maze and mazerun from the visualizer for both runs and put the screenshot into a3.md.  The screenshot must be visible on the page without need to further click (see lab 0 on how to do this if you forgot).  (part C is mandatory)
